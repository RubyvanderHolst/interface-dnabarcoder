...
urlpatterns = [
    ...
    path('cutoff/results', cutoff_views.cutoff_results_page,
         name='cutoff_results'),
    path('cutoff/results/<task_id>', cutoff_views.load_progress,
         name='load_progress_cutoff'),
    path('cutoff/<task_id>', cutoff_views.cutoff_results_page,
         ),
    ...
    path('classification/results/<task_id>', class_views.load_progress,
         name='load_progress_classification'),
    path('classification/<task_id>', class_views.classification_results_page,
         ),
